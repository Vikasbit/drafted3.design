...
/* ══ HERO WORDMARK - SIMPLE RESPONSIVE APPROACH ════ */
function initWordmark() {
  const wordmark = document.getElementById('wordmark');
  if (!wordmark) return;
  
  // Font will scale via CSS clamp() - no JS needed
  // Just ensure it animates in properly
  setTimeout(() => {
...
document.fonts.ready.then(initWordmark);
...
// All scroll listeners are already passive
console.log('drafted3 website initialized');
